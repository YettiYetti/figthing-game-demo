...
namespace fithing_game_demo
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Engine.form.backgroundmuzic.SoundLocation = ("../../../sounds/themesong.wav");
        }
        ...
        private void timerplayer2animations_Tick(object sender, EventArgs e)
        {
            Engine.player2.setIdleAnimation();
            Engine.player2.setMovingAnimation();
        }
        ...
        private void Restart_Click(object sender, EventArgs e)
        {
            ...
            if (Engine.Player1RoundWon == 0 && Engine.Player2RoundWon == 0)
            {
