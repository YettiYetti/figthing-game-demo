...
namespace fithing_game_demo
{
    public class Player2 : Player
    {
        ...
        public override void setAttackStance()
        {
            ...
            AttackRectangle.Size = new Size(80, 20);
            AttackRectangle.SizeMode = PictureBoxSizeMode.StretchImage;
            AttackRectangle.Location = new Point(getLocation().X - 30, Engine.player2.PlayerPosition.Y + 20);
            
            if (Engine.player2.isRight == true)
            {
                AttackRectangle.Location = new Point(getLocation().X + 20, getLocation().Y);
            }          
        }
        ...
        public override void setGetHitted()
        {
            ...
            Engine.player2.FlipImage();
            if (playerdamagedimgnum == Engine.form.player1damagedstances.Images.Count - 1)
            {
